...
export default function ProductUpdateForm(props) {
  ...
  async function handleSubmit() {
    ...
    let updateInfo = { ...productInfo };
    let images = [...updateInfo.images];
    ...
    let validateResult = validateProductInfo(updateInfo);
    if (!validateResult) return
    console.log(updateInfo);
    updateInfo.categories = updateInfo.categories.map(v => v._id);
    dispatch(productActions.updateProduct(updateInfo));
  }
  return (
